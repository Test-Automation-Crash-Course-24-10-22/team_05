...
button_for_comparement = browser.find_element(By.CLASS_NAME, 'compare-button')
...
time.sleep(3)
comparement_exit = browser.find_element(By.CLASS_NAME, 'modal__close')
...
delete_button.click()
time.sleep(3)
comparement_exit_2 = browser.find_element(By.CLASS_NAME, 'modal__close')
comparement_exit_2.click()
time.sleep(3)

button_for_favourite = browser.find_element(By.CLASS_NAME, 'product__favorites')
button_for_favourite.click()
time.sleep(5)
button_for_exit = browser.find_element(By.CLASS_NAME, 'modal__close')
